...
// based on https://web.archive.org/web/20190409173052/https://evanxmerz.com/blog/index.php/2016/10/07/recording-in-game-audio-in-unity/
...
#region Fields, Properties, and Inner Classes
    ...
    public void Write(float[] audioData)
    {
        ...
        for (int i = 0; i < audioData.Length; i++)
        {
            ...
            this
                .outputWriter
                .Write((short)(audioData[i] * (float) Int16.MaxValue));
        }
    }
...
#region File I/O
    public AudioRenderer.Result Save(string filename)
    {
        ...
        {
            Debug.LogWarning("There is no audio data to dave!");
    ...
    private void AddHeader()
    {
        ...
        writer
            ...
            (numberOfSamples * BITS_PER_SAMPLE * channels / 8)) -
            8);
